  ...
  return (
    <div className="bg-gray-100 min-h-screen py-8">
      <div className="container mx-auto px-4">
        <h1 className="text-2xl font-semibold mb-4">Tu Carrito de Compras</h1>
        {cartItems.length === 0 ? (
          ...
          <div className="flex flex-col md:flex-row gap-4">
                ...
                {cartItems.map(item => (
                  <div key={item.id} className="flex justify-between items-center border-b pb-4 mb-4">
                    <div className="flex items-center">
                      <img className="h-20 w-20 object-cover rounded mr-4" src={item.imagenUrl} alt={item.nombre} />
                      <div>
            ...
            <div className="md:w-1/4">
              <div className="bg-white rounded-lg shadow-md p-6">
                ...
                <Link to="/checkout" className="w-full mt-4 bg-blue-600 text-white py-2 rounded-lg hover:bg-blue-700 text-center block">
                    Proceder al Pago
                </Link>
              </div>
            </div>
