      ...
      <div className="container mx-auto p-4 sm:p-8">
        ...
        <div className="bg-white rounded-lg shadow-lg p-6 lg:p-10 flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:w-1/2 flex flex-col items-center">
            {/* Imagen Principal */}
            <img src={product.imagenUrl} alt={product.nombre} className="w-full h-96 object-contain rounded-lg shadow-md bg-gray-50 mb-4" />
          ...
          <div className="lg:w-1/2 lg:pl-8 flex flex-col justify-between">
            <div>
                ...
                <p className="text-2xl font-bold text-green-600 mb-6">${product.precio}</p>
                ...
                {product.stock === 0 && (
                    <p className="text-red-600 text-lg font-semibold mb-4">¡Producto agotado!</p>
                )}
                ...
                <button 
                  ...
                  className={`w-full flex justify-center items-center text-white font-bold py-3 px-6 rounded-lg transition-colors duration-300 ${
                    isAdding || product.stock === 0 ? 'bg-gray-400 cursor-not-allowed' : 'bg-blue-600 hover:bg-blue-700'
                  }`}
          ...
          <div className="border-b border-gray-200">
            <nav className="-mb-px flex space-x-8" aria-label="Tabs">
              <button
                ...
                className={`whitespace-nowrap py-4 px-1 border-b-2 font-medium text-lg ${activeTab === 'description' ? 'border-blue-500 text-blue-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'}`}
              >
                Descripción
              </button>
              <button
