        ...
        <div ref={searchRef} className="relative w-full md:w-1/2 order-3 md:order-2 mt-3 md:mt-0 hidden md:block">
          ...
          <form onSubmit={handleSearchSubmit} className="relative">
            ...
            <input
              ...
              onFocus={() => localSearchTerm.trim() && setShowSuggestions(true)} // Muestra al hacer foco si hay texto
            ...
            <div className="absolute top-full left-0 right-0 mt-2 bg-white border border-gray-300 rounded-md shadow-lg z-50 max-h-60 overflow-y-auto">
              {isLoadingSuggestions ? (
                ...
                <div className="p-4 space-y-3 animate-pulse">
                  {[...Array(3)].map((_, i) => ( // Muestra 3 placeholders
                ...
                <ul>
                  {suggestions.map((product) => (
                    ...
                    <button
                      ...
                      >
                        ...
                        />
                        {/* Nombre y Precio */}
                        <div className="flex-grow overflow-hidden"> {/* Contenedor para que el truncate funcione bien */}
                          <span className="block truncate text-sm text-gray-800">{product.nombre}</span>
                          {/* --- AÑADIR PRECIO AQUÍ --- */}
                  ...
                  {localSearchTerm.trim() && (
                    <li>
                      ...
                      >
                        Ver todos los resultados para "{localSearchTerm}"
                      </button>
                    </li>
                  )}
                </ul>
